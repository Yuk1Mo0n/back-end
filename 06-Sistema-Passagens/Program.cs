class Program
{
    ...
    {
        Console.Clear();
        Console.WriteLine("Bem-vindo ao Cucasbus");
        Console.WriteLine("-----------------------");
        Console.WriteLine("Contamos com 42 lugares diponísveis");
        ...
        do
        {
            ...
            switch (opcao)
            {
                case "0":
                    ...
                    System.Threading.Thread.Sleep(1000); //Codigo de espera (agora ele ta esperando um 1 segundo)
                    break;
                case "1":
                    ComprarPassagem();
                    break;
